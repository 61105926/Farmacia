...
class CreatePresalesSalesTables extends Command
{
    protected $signature = 'tables:create-presales-sales';
    protected $description = 'Crear tablas de preventas y ventas';

    public function handle()
    {
        try {
            $this->info('Creando tablas de preventas y ventas...');
            ...
            $this->info('✅ Tabla presales creada');
            ...
            $this->info('✅ Tabla presale_items creada');
            ...
            $this->info('✅ Tabla sale_items creada');
            
            $this->info('🎉 ¡Todas las tablas creadas exitosamente!');
            $this->info('Ahora puedes acceder a /preventas y /ventas sin problemas.');
